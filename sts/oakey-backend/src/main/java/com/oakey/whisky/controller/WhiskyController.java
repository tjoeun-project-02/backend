...
import com.oakey.whisky.dto.WhiskyOcrSearchRequest;
...
public class WhiskyController {
    ...
    @PostMapping("/ocr/top3")
    public ResponseEntity<List<WhiskyResponse>> ocrTop3(@RequestBody WhiskyOcrSearchRequest request) {
    if (request == null) {
        return ResponseEntity.ok(List.of());
    }

    List<WhiskyResponse> result = whiskyService.findTop3ByOcrText(
            request.getText(),
